    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: 'categories',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/blogs-control/blogs-control.component').then(
                (c) => c.BlogsControlComponent,
              ),
          },
          {
            path: 'fast-news',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/news-control/fast-news/fast-news.component').then(
                (c) => c.FastNewsComponent,
              ),
          },
          {
            path: 'news-add/:id',
          ...
          },
          {
            path: 'comments',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/comments-control/comments-control/comments-control.component').then(
                (c) => c.CommentsControlComponent,
              ),
          },
          {
            path: 'users-control',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/users-control/users-control/users-control.component').then(
                (c) => c.UsersControlComponent,
              ),
          },
          {
            path: 'social-media-control',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/social-media-control/social-media-control.component').then(
                (c) => c.SocialMediaControlComponent,
              ),
          },

          {
            path: 'about-us',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/pages-control/about-us-control/about-us-control.component').then(
                (c) => c.AboutUsControlComponent,
              ),
          },
          {
            path: 'privacy-policy',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/pages-control/privacy-policy/privacy-policy.component').then(
                (c) => c.PrivacyPolicyComponent,
              ),
          },
          {
            path: 'administrator',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/pages-control/employees-control/employees-control.component').then(
                (c) => c.EmployeesControlComponent,
              ),
          },
          {
            path: 'contact-us',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/pages-control/contact-us/contact-us.component').then(
                (c) => c.ContactUsComponent,
              ),
          },
          {
            ...
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/settings-control/setting-control/setting-control.component').then(
                (c) => c.SettingControlComponent,
              ),
          },
          {
            path: 'youtube',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/yout-ube-control/yout-ube-control.component').then(
                (c) => c.YoutUbeControlComponent,
              ),
          },
          {
            path: 'help',
            loadComponent: () =>
              import('./dashboard/components/dashboard-home/verifications-control/verifications-help/verifications-help.component').then(
                (c) => c.VerificationsHelpComponent,
              ),
          },
        ],
      },
